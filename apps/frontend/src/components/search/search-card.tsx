			...
			>
				<div className="flex gap-4">
					<img
						src={imageUrl}
						alt=""
						className="w-[133px] h-[200px] object-cover rounded flex-shrink-0"
					/>

					<CardHeader className="flex-1 min-w-0 flex flex-col gap-2 p-0">
						<div className="flex items-center gap-2 w-full">
							<CardTitle className="text-lg line-clamp-1">{m.title}</CardTitle>
							{m.release_date && (
		...
		return (
			...
			>
				<div className="flex gap-4">
					...
					<CardHeader className="flex-1 min-w-0 flex flex-col gap-2 p-0">
						<div className="flex items-center gap-2 w-full">
							<CardTitle className="text-lg line-clamp-1">{tv.name}</CardTitle>
							{tv.first_air_date && (
								<span className="text-sm text-muted-foreground flex-shrink-0">
				...
				<div className="flex gap-4">
					...
					<CardHeader className="flex-1 min-w-0 flex flex-col gap-2 p-0">
						<div className="flex items-center w-full">
							...
							<Badge
								variant="secondary"
								className="bg-green-500/10 text-green-500 hover:bg-green-500/20 min-w-18 justify-center ml-auto"
							>
								Person
							</Badge>
						</div>
